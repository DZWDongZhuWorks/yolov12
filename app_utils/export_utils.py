...
def build_payload(result, simplify_mode, simplify_eps_coeff, polygon_opt_steps, model_name: str, image_info: Dict[str, Any],
...
def export_results_cache(
    ...
    for model_name, results in results_cache.items():
        ...
        payload = build_payload(results[0], simplify_mode, simplify_eps_coeff, polygon_opt_steps, model_name=model_name, image_info=image_info,
                                allowed_class_ids=allowed_class_ids)
